...
export function PrivacyPolicy({ onBack, onTermsClick, onGDPRClick }: PrivacyPolicyProps) {
  return (
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <div className="space-y-8 text-muted-foreground">
              <section>
                ...
                <p>
                  Para una más información complementaria sobre la protección de datos personales te invitamos a consultar la página web de la AEPD (Agencia Española de Protección de Datos){" "}
                  <a href="https://www.agpd.es/portalwebAGPD/index-ides-idphp.php" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
              ...
              <section>
                ...
                <p>
                  Durante la primera navegación, aparecerá un banner explicativo sobre el uso de cookies, que incluye la posibilidad de aceptar todas las cookies o solo las cookies técnicas, esenciales para el funcionamiento de la plataforma; con exclusión de las cookies analíticas y publicitarias.
                </p>
                <p>
              ...
              <section>
                ...
                <p>
                  Salvo que el Usuario se oponga, enviando un email a la dirección de correo electrónico <a href="mailto:bip@bipsenior.com" className="text-primary hover:underline">bip@bipsenior.com</a>, sus datos podrán ser utilizados, en su caso, si procede, para el envío de información comercial de Bip Senior.
                </p>
                <p>
                ...
                <p>
                  El Usuario es responsable de que la información que proporcione a través de esta página web sea cierta, respondiendo de la exactitud de todos los datos que comunique y mantendrá actualizada la misma para que reflejen una situación real, siendo responsable de informaciones falsas o inexactas que proporcione y de los daños, molestias y problemas que pudieran causar a Bip Senior o a terceros.
                </p>
                <p>
                ...
                <p>
                  Bip Senior declina, cualquier tipo de responsabilidad sobre las consecuencias de esos actos puedan tener para el Usuario, si publicó la información voluntariamente.
                </p>
                <p>
                  Podrá acceder y ejercitar esos derechos mediante solicitud por escrito y firmada que podrá ser enviada al domicilio Avda. Andrés Hernandez Ros, 30107 Murcia, adjuntando fotocopia del DNI o documento equivalente.
                </p>
                <p>
                  También podrá ser enviada la solicitud al siguiente correo electrónico: <a href="mailto:bip@bipsenior.com" className="text-primary hover:underline">bip@bipsenior.com</a>
                </p>
                <p>
